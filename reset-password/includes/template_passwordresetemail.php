                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            You recently requested for a password reset on {{ APP_NAME }} with the email
                                            [{{ email }}]. Please use below button
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="{{ url }}" style="color: #ffffff; text-decoration: none;">Reset
                                                Password</a>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table border="0" width="400" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="center"
                                        style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            If above button does not work, copy the link given below and paste into your
                                            browser.
                                        </div>
                                    </td>
                                </tr>
