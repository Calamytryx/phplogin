  ...
  <?php } else { ?>
    ...
    <div class="container">
      <a class="navbar-brand" href="../home">
        ...
        <?php } else { ?>
          <img src="../assets/images/random.png" alt="" width="50" height="50" class="mr-3">
        <?php } ?>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="imgdropdown">
                <a class="dropdown-item text-muted" href="../profile"><i class="fa fa-user pr-2"></i>
                  Profile</a>
                <a class="dropdown-item text-muted" href="../profile-edit"><i class="fa fa-pencil-alt pr-2"></i> Edit
                  Profile</a>
