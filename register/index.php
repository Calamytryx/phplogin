            ...
            <form class="form-auth" action="includes/register.inc.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input oninvalid="this.setCustomValidity('Please input a Username')" oninput="setCustomValidity('')"
                        type="text" id="username" name="username" class="form-control" placeholder="Username" required
                        autofocus>
                    <sub class="text-danger">
                        <?php
                ...
                <div class="form-group">
                    ...
                    <input style="text-transform: capitalize;"
                        oninvalid="this.setCustomValidity('Please input Your Given Name')"
                        oninput="setCustomValidity('')" type="text" id="first_name" name="first_name"
                ...
                <div class="form-group">
                    ...
                    <input style="text-transform: capitalize;"
                        oninvalid="this.setCustomValidity('Please input Your Family Name')"
                ...
                <div class="form-group">
                    ...
                    <input oninvalid="this.setCustomValidity('Please input a Password')" oninput="setCustomValidity('')"
                        for="password" type="password" id="password" name="password" class="form-control"
