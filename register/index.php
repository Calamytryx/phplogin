    ...
    <div class="col-lg-4">
      ...
      <form class="form-auth" action="includes/register.inc.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input oninvalid="this.setCustomValidity('Please input a Username')" oninput="setCustomValidity('')"
        ...
        <div class="form-group">
          ...
          <input style="text-transform: capitalize;" oninvalid="this.setCustomValidity('Please input Your Given Name')"
            oninput="setCustomValidity('')" type="text" id="first_name" name="first_name" class="form-control"
            placeholder="First Name" required autofocus>
        </div>

        <div class="form-group">
          <label for="last_name" class="sr-only">Last Name</label>
          <input style="text-transform: capitalize;" oninvalid="this.setCustomValidity('Please input Your Family Name')"
            oninput="setCustomValidity('')" type="text" id="last_name" name="last_name" class="form-control"
        ...
        <div class="form-group">
          ...
          <input oninvalid="this.setCustomValidity('Please input a Password')" oninput="setCustomValidity('')"
            for="password" type="password" id="password" name="password" class="form-control" placeholder="Password"
            required>
        </div>

        <div class="form-group mb-4">
          <label for="confirmpassword" class="sr-only">Confirm Password</label>
          <input oninvalid="this.setCustomValidity('Please retype the password correctly')"
            oninput="setCustomValidity('')" type="password" id="confirmpassword" name="confirmpassword"
        ...
        <button class="btn btn-lg btn-dark btn-block" type="submit" name='signupsubmit'>Signup</button>
