...
if (!isset($_POST['loginsubmit'])) {
  ...
  $_POST = array_map('_cleaninjections', $_POST);
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      if ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!$pwdCheck) {
          ...
          $_SESSION['auth'] = $row['verified_at'] !== NULL ? 'verified' : 'loggedin';
          $_SESSION['id'] = $row['id'];
          ...
          if (isset($_POST['rememberme'])) {
            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
              ...
              mysqli_stmt_bind_param($stmt, "ssss", $_SESSION['email'], $selector, $hashedToken, $expiresAt);
              mysqli_stmt_execute($stmt);
            }
          }
